...
def attack(char_name: str, char_class: str) -> str:
    """Метод атаки. Выдает урон. Присутсвует элемент случайности."""
...
def defence(char_name: str, char_class: str) -> str:
    """Метод защиты. Выдает блокировку. Присутсвует элемент случайности."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    ...
    return (f'{char_name} Специальное условие не применено')
...
#test gitbash
#comment i will see how it goes
